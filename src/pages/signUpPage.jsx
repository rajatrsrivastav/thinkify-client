...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-900 text-white relative flex items-center justify-center overflow-hidden">
      ...
      <main className="relative z-10 grid md:grid-cols-2 items-center gap-16 w-full max-w-6xl p-8">
        <div className="hidden md:flex flex-col gap-4">
          ...
          <h1 className="text-5xl font-bold tracking-tight">Begin Your Journey with Thinkify</h1>
          <p className="text-gray-300 text-lg">
            Create an account to start deconstructing complex problems and building your mastery.
          </p>
        </div>
        ...
        <div className="bg-black/40 backdrop-blur-lg border border-white/10 rounded-2xl p-8 w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Join a community of forward-thinkers.</p>
          </div>
